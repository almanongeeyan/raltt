...
<body>
	...
	<section class="min-h-screen py-0 px-0 bg-transparent">
		<div class="max-w-4xl mx-auto text-center pt-[50px] pb-6 px-4">
			...
			<div class="text-base md:text-lg text-textlight mb-2 font-medium">Explore our beautiful, nature-inspired floral tile designs for a vibrant look.</div>
			<div class="text-sm text-textlight mb-6">All tiles in the Floral design available at your branch.</div>
			<!-- Filter Buttons Only -->
		...
		<div class="max-w-7xl mx-auto mt-2 md:mt-6">
			<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
				<?php if (empty($filteredProducts)): ?>
					<div class="col-span-full text-center text-textlight py-8">No Floral tiles found for your branch.</div>
				<?php else: ?>
