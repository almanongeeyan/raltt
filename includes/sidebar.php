    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 992px) {
            ...
            .sidebar-header, .dashboard-title, .user-info, .sidebar-nav-link span, .logout-link span {
                opacity: 0;
                visibility: hidden;
                height: 0;
                margin: 0;
        ...
        <div class="sidebar-content">
            <div class="sidebar-top">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-nav-item">
                        <a href="../staffadmin_access/admin_completeorder.php" class="sidebar-nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <li class="sidebar-nav-item">
                        <a href="../staffadmin_access/admin_addsupplier.php" class="sidebar-nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
